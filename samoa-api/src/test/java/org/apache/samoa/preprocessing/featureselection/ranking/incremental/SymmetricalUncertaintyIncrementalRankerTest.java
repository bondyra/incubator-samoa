...
public class SymmetricalUncertaintyIncrementalRankerTest {

  @Tested
  private SymmetricalUncertaintyIncrementalRanker ranker;
  @Mocked
  private FeatureSet featureSet;

  @Before
  public void setUp() {
    ranker = new SymmetricalUncertaintyIncrementalRanker();
  }
  ...
  public void testThatProcessForNormalUseCaseWorks() {
    ...
    for (Map.Entry<Integer, Double> vi : values.entrySet()) {
      if (vi.getKey() == 1)
        assertEquals(0.343711d, vi.getValue(), 1e-7);
      else
        assertEquals(1d, vi.getValue(), 1e-7);
    }
